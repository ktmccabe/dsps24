...
*A video explainer of the loop in this section using a similar dataset that goes through 2020. We now have data going through 2021!* {{< video src="https://www.youtube.com/watch?v=Ij9YWgUQg_s" >}}
...
```{r, include=F}
justices <- read.csv("data/justices23.csv", stringsAsFactors = T)
```
