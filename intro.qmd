...
1.  Create a .R script saved as "LastnameSetup1.R" (use your last name). If you use the template on Canvas, after opening in RStudio, use File -\> Save As to change to create this file nam. Within the body of this file, make sure to title it and provide your name.
